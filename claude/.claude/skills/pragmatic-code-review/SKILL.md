...
1. Get changes to review: `git diff develop...HEAD` or `gh pr diff <number>`
2. Scan all changed files to understand scope
3. Apply the hierarchical review framework
4. Output findings using the report structure below
