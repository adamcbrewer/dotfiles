...
module.exports = {
  config: {
    ...
    selectionColor: "#20C5C655",
    // border color (window, tabs)
    borderColor: "#333",
    // custom CSS to embed in the main window
    css: `
      .splitpane_divider_horizontal { background-color: #444 !important; }
      .splitpane_divider_vertical { background-color: #444 !important; }
    `,
    ...
    // bellSoundURL: "/home/adam/Music/Sounds/Super Mario Brothers/smb3_bump.wav",
  ...
  keymaps: {
    ...
    "editor:moveBeginningLine": ["home", "cmd+a"],
    "editor:moveEndLine": ["end", "cmd+e"],
    ...
    // "editor:clearBuffer": "ctrl+shift+r",
    "editor:break": ["cmd+c"],
